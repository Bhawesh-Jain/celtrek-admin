...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const repo = new ProductRepository(String(company_id))
    var data = await repo.addProductImage(is_main, String(product_id), String(user_id), imageEntry as File)
